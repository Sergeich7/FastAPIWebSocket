...
<html>
    ...
    <body>
        ...
        <script>
            var ws = new WebSocket('ws://' + document.domain + ':8000""" +\
                settings.API_PREFIX + TASK_PREFIX +\
                """/ws');
...
ws_router = APIRouter(prefix=settings.API_PREFIX + TASK_PREFIX)
